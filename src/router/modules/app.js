...
const app = [{
  ...
  meta: {title: 'aaaa'},
  children: [
    {name: 'index', path: 'index', component: IntroduceIndex},
    {name: 'detail', path: 'detail', component: Detail},
    {name: 'leader', path: 'leader', component: Leader},
    {name: 'floor', path: 'floor', component: Floor}
  ]
},{
  path: '/expert',
  component: Expert,
  ...
  children: [
    {name: 'guideIndex', path: 'index', component: GuideIndex},
    {name: 'emergency', path: 'emergency', component: Emergency},
  ]
},{
  path: '/intelligence',
